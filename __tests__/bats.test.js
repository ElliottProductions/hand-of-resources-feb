...
describe('backend-express-template routes', () => {
  ...
  it.skip('POST /bats/:id should update a bat', async () => {
  ...
  it.skip('DELETE /bats/:id should delete a bat', async () => {
